...
static std::vector<std::vector<unsigned int>> classStatGrowth =
{
	...
	{	4,	2,	5,	3,	2,	2 }, // MONK 12
	{	4,	5,	3,	2,	5,	5 }, // BUCCANEER 13
	{	5,	2,	5,	5,	3,	4 }, // BATTLEMAGE 14
	{	4,	4,	4,	4,	4,	4 }, // ASCETIC 15
	{	3,	2,	4,	6,	4,	4 }, // CONJURER 16
	{	3,	3,	1,	6,	6,	3 }, // ACCURSED 17
	{	3,	3,	1,	6,	4,	7 }, // MESMER 18
	{	4,	5,	5,	2,	3,	5 }, // BREWER 19
	{	5,	2,	4,	5,	4,	4 }, // NECROKNIGHT 20
	{	2,	5,	3,	4,	6,	4 }, // APOTHECARY 21
	{	3,	6,	3,	3,	7,	2 }, // EXTERMINATOR 22
	{	2,	3,	2,	6,	6,	5 }, // LOREMASTER 23
	{	2,	5,	2,	4,	7,	4 }, // MACHINIST 24
	{	4,	3,	2,	3,	4,	4 }, // PUNISHER 25
	{	4,	4,	4,	4,	4,	4 }, // SHAMAN 26
	{	1,	7,	1,	4,	7,	4 }  // HUNTER 27
};
