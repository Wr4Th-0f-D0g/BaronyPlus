        ...
        if ( !doShortTooltip && itemTooltip.detailsText.size() > 0 )
        {
            ...
            for ( auto& tag : itemTooltip.detailsTextInsertOrder )
            {
                         ...
                         || itemCategory(item) == GEM )
                {
					...
					else if (tag.compare("STR_stat_bonus") == 0)
					{
						if (!items[item->type].hasAttribute("STR"))
						{
							continue;
					...
					else if (tag.compare("DEX_stat_bonus") == 0)
					{
						if (!items[item->type].hasAttribute("DEX"))
						{
							continue;
						}
					}
					else if (tag.compare("CON_stat_bonus") == 0)
					{
						if (!items[item->type].hasAttribute("CON"))
						{
							continue;
						}
					}
					else if (tag.compare("INT_stat_bonus") == 0)
					{
						if (!items[item->type].hasAttribute("INT"))
						{
							continue;
						}
					}
					else if (tag.compare("PER_stat_bonus") == 0)
					{
						if (!items[item->type].hasAttribute("PER"))
						{
							continue;
						}
					}
					else if (tag.compare("CHR_stat_bonus") == 0)
					{
						if (!items[item->type].hasAttribute("CHR"))
						{
							continue;
						}
					}
